...
import { faBagShopping, faUser, faGem, faHeart } from "@fortawesome/free-solid-svg-icons";
...
export const MainHeader = () => {
  ...
  const memoizedBagTotalQuantity = useMemo(() => bagTotalQuantity, [bagTotalQuantity]);
  const memoizedWishlistTotalQuantity = useMemo(() => wishlistTotalQuantity, [wishlistTotalQuantity]);
