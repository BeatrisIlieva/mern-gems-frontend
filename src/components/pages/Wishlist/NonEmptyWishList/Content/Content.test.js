...
jest.mock('../../../../common/LargeImages/LargeImages', () => ({
  LargeImages: ({ jewelriesByCategory, clickHandler }) => (
    <div>
...
describe('Content Component', () => {
  ...
  test('renders correctly with items in jewelriesByCategory', () => {
    render(
      <Content categoryTitle="Necklaces" colorTitle="Gold" />
    );
  ...
  test('does not render anything when jewelriesByCategory is empty', () => {
    ...
    expect(screen.queryByText('Large Images Component')).not.toBeInTheDocument();
  });
